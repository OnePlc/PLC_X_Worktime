...
use OnePlace\Worktime\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/worktime/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/worktime/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('worktime-api');
    }
}
