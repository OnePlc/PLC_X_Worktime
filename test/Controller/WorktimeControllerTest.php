<?php
/**
 * WorktimeControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Worktime Module
 *
 * @category Test
 * @package Worktime
...
namespace OnePlaceTest\Worktime\Controller;

use OnePlace\Worktime\Controller\WorktimeController;
...
class WorktimeControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/worktime', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('worktime');
        $this->assertControllerName(WorktimeController::class); // as specified in router's controller name alias
        $this->assertControllerClass('WorktimeController');
        $this->assertMatchedRouteName('worktime');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/worktime/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('worktime');
        $this->assertControllerName(WorktimeController::class); // as specified in router's controller name alias
        $this->assertControllerClass('WorktimeController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/worktime/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('worktime');
        $this->assertControllerName(WorktimeController::class); // as specified in router's controller name alias
        $this->assertControllerClass('WorktimeController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/worktime/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('worktime');
        $this->assertControllerName(WorktimeController::class); // as specified in router's controller name alias
        $this->assertControllerClass('WorktimeController');
